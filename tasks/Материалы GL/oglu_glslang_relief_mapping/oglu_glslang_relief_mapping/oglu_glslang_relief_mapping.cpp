//-----------------------------------------------------------------------------
//           Name: oglu_glslang_relief_mapping.cpp
//         Author: Tristan Dean (twixn@twixn.com)
//  Last Modified: 07/16/07
//    Description: This sample demonstrates the usage of 'Relief' mapping. 
//                 Please note that this is simply a modification of an official 
//                 CodeSampler.com sample. All changes will be marked with a 
//                 'new' block. Press 'F1' to toggle Relief mapping.
//-----------------------------------------------------------------------------
					...
					int       nCmdShow )
{
	...
	g_hWnd = CreateWindowEx( NULL,"MY_WINDOWS_CLASS",
						    "OpenGL - Simple Relief Mapping Using GLslang",
							WS_OVERLAPPEDWINDOW,
...
void init( void )
{
	...
	AUX_RGBImageRec *pTextureImage = auxDIBImageLoad( ".\\texturemap.bmp" );
    ...
    ///////////////////////////////////////////////////////////
    pTextureImage = auxDIBImageLoad( ".\\heightmap.bmp" );
...
void setShaderConstants( void )
{
	...
	// The best way is to inversely transform the eye position by
